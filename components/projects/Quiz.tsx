...
export function Quiz({ id, question, options, correct, explanation }: QuizProps) {
  const { isBlockCompleted, markBlockCompleted } = useProject();
  ...
  const isCorrect = hasSubmitted && selectedOption === correct;
  const isIncorrect = hasSubmitted && selectedOption !== correct;
      ...
      >
        ...
        <div className="space-y-3 mb-6">
          {options.map((option, index) => {
            ...
            const isThisCorrect = index === correct;
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between gap-4">
                  <span
                    className={isCompleted && !isThisCorrect ? 'text-zinc-500' : 'text-zinc-300'}
                  >
                    {option}
                  </span>
        ...
        {/* Try Again / Show Explanation buttons */}
        ...
        <AlertDialogContent className="bg-zinc-900 border-zinc-800">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-zinc-400">
              Viewing the explanation will reveal the correct answer. Are you sure you want to
              continue?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
