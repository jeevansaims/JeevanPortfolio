            ...
            <div className="flex justify-between mt-auto pt-4 border-t border-zinc-700/50">
              ...
              <Dialog>
                ...
                <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto bg-zinc-900 border-zinc-700 text-white custom-scrollbar-phthalo">
                  <DialogHeader>
                    <DialogTitle className="text-xl font-bold text-white">H10 ECG Monitor - App Support</DialogTitle>
                  ...
                  <div className="space-y-6 mt-4">
                    ...
                    <div className="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700/50">
                      ...
                      <p className="text-zinc-300">
                        <strong className="text-white">App Support:</strong> contact@mirkovic.dev
                      </p>
                      <p className="text-zinc-400 text-sm mt-1">
                        For questions about H10 ECG Monitor, please contact me directly.
                      </p>
                    </div>
                    ...
                    <div className="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700/50">
                      ...
                      <ul className="text-zinc-300 space-y-2 text-sm">
                        <li className="flex items-start gap-2">
                          ...
                          <span>Ensure your Polar H10 is properly positioned and moistened</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-phthalo-500 mt-1">•</span>
                        ...
                        <li className="flex items-start gap-2">
                          <span className="text-phthalo-500 mt-1">•</span>
                          <span>Select your Polar H10 from the list</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-phthalo-500 mt-1">•</span>
                    ...
                    <div className="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700/50">
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <p className="text-zinc-400 text-sm">Check Bluetooth is enabled and H10 is on</p>
                        </div>
                        <div>
                    ...
                    <div className="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700/50">
                      ...
                      <ul className="text-zinc-300 space-y-2 text-sm">
                        <li className="flex items-start gap-2">
                          <span className="text-phthalo-500 mt-1">•</span>
                          <span><strong className="text-white">Real-time ECG:</strong> Live 130Hz streaming from Polar H10</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-phthalo-500 mt-1">•</span>
                    ...
                    <div className="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700/50">
                      ...
                      <ul className="text-zinc-300 space-y-2 text-sm">
                        ...
                        <li className="flex items-start gap-2">
                          <span className="text-phthalo-500 mt-1">•</span>
                          <span>Polar H10 chest strap (sold separately)</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-phthalo-500 mt-1">•</span>
                    ...
                    <div className="text-center pt-4 border-t border-zinc-700">
                      <p className="text-zinc-500 text-sm">
                        H10 ECG Monitor v1.0 | Developed by Antonije Mirkovic
                      </p>
                    </div>
                  </div>
                </DialogContent>
