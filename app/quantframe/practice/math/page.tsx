// app/quantframe/practice/math/page.tsx
'use client'
...
function MathPracticeContent() {
      ...
      <div className="min-h-screen flex items-center justify-center px-4">
        <Card className="w-full max-w-2xl bg-zinc-900/50 border-zinc-800 backdrop-blur-sm p-8 text-center">
          ...
          <div className="flex justify-center">
            <Button
              onClick={() => router.push('/quantframe/practice')}
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        <Card className="w-full max-w-2xl bg-zinc-900/50 border-zinc-800 backdrop-blur-sm p-8 text-center">
          ...
          <Button onClick={() => router.push('/quantframe/practice')}>
            Back to Generator
          </Button>
        </Card>
      </div>
  ...
  return (
    <ProblemCard
      ...
      onEditFilters={() => router.push('/quantframe/practice')}
