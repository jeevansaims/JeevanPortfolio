    ...
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ...
          : "bg-zinc-900/95 backdrop-blur-md md:bg-transparent md:backdrop-blur-none"
      }`}
    >
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link
              href="/quantframe/login"
              className="text-zinc-300 hover:text-white transition-colors"
            >
              Log in
            </Link>
            <Link href="/quantframe/register">
              <Button
                size="sm"
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden py-4 space-y-3 border-t border-zinc-800 bg-zinc-900/95 backdrop-blur-md rounded-b-lg">
            ...
            <div className="px-2 pt-2 border-t border-zinc-800/50 mt-3">
              <Link href="/quantframe/register" onClick={() => setIsMobileMenuOpen(false)}>
                <Button
                  size="sm"
