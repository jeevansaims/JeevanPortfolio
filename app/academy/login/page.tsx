            ...
            <div className="relative bg-zinc-900/90 backdrop-blur-sm border border-zinc-800 rounded-2xl p-8 shadow-2xl">
                  ...
                  <div className="p-3 rounded-lg bg-red-500/10 border border-red-500/20">
                    <p className="text-sm text-red-400">
                      ...
                      {error.includes('No account found') && (
                        <Link href="/academy/register" className="ml-1 underline font-medium">
                          Register instead →
                        </Link>
                      )}
              ...
              <div className="mt-6 text-center">
                <p className="text-sm text-zinc-400">
                  ...
                  <Link href="/academy/register" className="text-phthalo-400 hover:text-phthalo-300 font-medium">
                    Register →
                  </Link>
                </p>
              </div>
