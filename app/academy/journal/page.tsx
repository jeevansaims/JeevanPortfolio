...
import { JournalPost } from '@/app/academy/types/journal';
...
export const metadata = {
  title: 'Quant Journal | Mirkovic Academy',
  description:
...
function FeaturedPost({ post }: { post: JournalPost }) {
  return (
    <Link href={`/academy/journal/${post.slug}`} className="group block">
...
function PostCard({ post }: { post: JournalPost }) {
  return (
    <Link href={`/academy/journal/${post.slug}`} className="group block h-full">
