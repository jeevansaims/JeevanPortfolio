// app/academy/programs/[program]/modules/[module]/lessons/[lesson]/quiz/page.tsx
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href={`/academy/programs/${params.program}/modules/${params.module}/lessons/${params.lesson}`}>
