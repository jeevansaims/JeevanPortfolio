// app/academy/programs/[program]/modules/[module]/lessons/[lesson]/quiz/quiz-client.tsx
'use client'
...
import { submitQuiz } from '@/app/academy/actions/quiz'
...
export function QuizClient({
  ...
  const handleContinueToLesson = () => {
    router.push(`/academy/programs/${programSlug}/modules/${moduleSlug}/lessons/${lessonSlug}`)
  }
