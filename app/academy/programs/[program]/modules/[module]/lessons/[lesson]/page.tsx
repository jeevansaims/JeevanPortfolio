// app/academy/programs/[program]/modules/[module]/lessons/[lesson]/page.tsx
      ...
      <div className="bg-gradient-to-b from-zinc-900 to-black border-b border-zinc-800">
        <div className="max-w-5xl mx-auto px-6 py-12">
          ...
          <div className="flex items-center gap-2 text-sm text-zinc-500 mb-4">
            ...
            <span>/</span>
            <Link href={`/academy/programs/${params.program}/modules/${params.module}`} className="hover:text-white transition-colors">
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        {user && (
          <div className="mt-12 pt-8 border-t border-zinc-800">
            {hasQuiz ? (
              <Link href={`/academy/programs/${params.program}/modules/${params.module}/lessons/${params.lesson}/quiz`}>
                <Button
                  size="lg"
                  className={`w-full ${
                    isCompleted
